const app = (function () {
  ...
  const readForm = function () {
    ...
    const currentPanel = getCurrentPanel(),
      ...
      exitTab =
        currentlySelectedNestedExitTabIndex != -1
          ? currentPanel.exitTabs[currentlySelectedExitTabIndex].nestedExitTabs[
              currentlySelectedNestedExitTabIndex
            ]
    ...
    const currentBlockElem = getCurrentBlockElem();
    const blockElemType =
  ...
  const updateForm = function () {
    ...
    const exitTab =
      currentlySelectedNestedExitTabIndex != -1
        ? panel.exitTabs[currentlySelectedExitTabIndex].nestedExitTabs[
            currentlySelectedNestedExitTabIndex
          ]
        : panel.exitTabs[currentlySelectedExitTabIndex];
    ...
    for (
      ...
      panelButton.className =
        currentlySelectedPanelIndex == panelIndex ? "active" : "";
    ...
    for (
      ...
      subPanelButton.className =
        currentlySelectedSubPanelIndex == subPanelIndex ? "active" : "";
    ...
    for (
      ...
      exitTabButton.className =
        "exitTabSelect" + (currentlySelectedExitTabIndex == exitTabIndex)
          ? " active"
          : "";
    ...
    g_actionMessage.className =
      currentlySelectedSubPanelIndex != -1 ? "invisible" : "";
    ...
    subPanelHeight.style.display =
      currentlySelectedSubPanelIndex > 0 ? "initial" : "none";
    subPanelHeightLabel.style.display =
      currentlySelectedSubPanelIndex > 0 ? "inline-block" : "none";

    subPanelLength.style.display =
      currentlySelectedSubPanelIndex != -1 && panel.sign.subPanels.length > 1
        ? "initial"
        : "none";
    ...
    document.querySelector("#SMSPSelectLabel").textContent =
      "Selected: Row " + (currentlySelectedRowIndex + 1);
    document.querySelector("#SMSPElementLabel").textContent =
      "Selected: Block " + (currentlySelectedBlockIndex + 1);
    ...
    for (
      ...
      sMControlRow.className =
        "sMControlRow" + (row == currentlySelectedRowIndex ? " selected" : "");
      ...
      for (let item = 0; item < sign.blockElements.rows[row].length; item++) {
        ...
        textEditorBlock.className =
          ...
          (item == currentlySelectedBlockIndex &&
          row == currentlySelectedRowIndex
            ? " selected"
            : "");
    ...
    for (const divConfig of document.querySelectorAll(
      ...
      if (
        ...
        Control.prototype.blockInternalElements[
          Control.prototype.blockToClassElems.getElem(getCurrentBlockElem())
        ]
      ) {
